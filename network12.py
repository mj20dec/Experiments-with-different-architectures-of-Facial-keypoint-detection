...
z_conv2 = tf.nn.conv2d(max_pool1,w_conv2,strides = [1,2,2,1], padding='SAME')+b_conv2
print(z_conv2.shape)
...
flat1 = tf.reshape(max_pool2,[-1,2304])

# dropout
drp = tf.nn.dropout(flat1,keep_prob = 0.4)

#Fully connected 
w_fc1 = tf.get_variable("w_fc1",shape = [2304,128])
